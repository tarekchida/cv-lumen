...
<html lang="en" class="no-js">
    <head>
        ...
        <meta name="description" content="Je suis un full stack devlopper qui vit à Paris, France. Je passe mes jours sur de nombreux domaines de développement web du back-end (PHP) à la programmation front-end (HTML, CSS et jQuery / Javascript).">
                ...
                <div class="pt-wrapper">
                    ...
                    <div class="site-nav mobile-menu-hide">
                        ...
                        <ul class="social-links">
                            ...
                            <li> <a href="http://cv.tchida.net/en"><img src="assets/images/en.png" alt="En"></a></li>
                        </ul>
                        <!-- /Social buttons -->
                    </div>
                    <!-- Navigation & Social buttons -->
